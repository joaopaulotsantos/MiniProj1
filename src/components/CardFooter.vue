<template>
    <div>
        <p class="text-center text-blue-600"># CiscoCCNA #DotNetCore #WebApplication</p>
        <hr class="border-1 my-8 border-gray-400 sm:w-4/12 mx-auto">
    
        <div class="text-center">
            <a href="https://github.com/joaopaulotsantos" target="_blank"
            ...
            <a href="mailto:joaopaulotsantos@gmail.com"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
